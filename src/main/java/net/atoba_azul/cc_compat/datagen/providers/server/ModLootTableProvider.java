...
import static net.atoba_azul.cc_compat.registries.CompatBlocks.*;


public class ModLootTableProvider extends LootTableProvider {
    public ModLootTableProvider(PackOutput pOutput) {
        super(pOutput, BuiltInLootTables.all(), ImmutableList.of(new SubProviderEntry(ModBlockLoot::new, LootContextParamSets.BLOCK)));
    }
